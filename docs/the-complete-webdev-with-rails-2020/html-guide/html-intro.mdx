...
## Create project for this course

We are going to make folder **`udemy-complete-web-dev`** in Desktop.
...
![make-html-test-folder](../../img/20200506_055038.gif)
...
![open-first-html](../../img/20200506_070602.gif)
