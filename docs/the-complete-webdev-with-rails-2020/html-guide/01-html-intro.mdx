...
!!! abstract "Chapter Goals" - Understand what is HTML - Make a basic HTML file - Browse HTML file in a web browser

## What is HTML ?

From wikipedia...

> Hypertext Markup Language (HTML) is the standard markup language for **_==documents designed to be displayed in a web browser==_**.
...
![ss](https://storage.googleapis.com/coderhackers-assets/the-complete-webdev-with-rails-2020/html-guide/w3-school-html.png)
